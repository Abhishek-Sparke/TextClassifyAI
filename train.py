...
Executes data loading, text preprocessing, TF-IDF feature extraction,
training of 4 classifiers, evaluation, visualization generation, and
...
def run_pipeline():
    print("=" * 80)
    print(" PROJECT: Classifying Text Documents Using Machine Learning")
    print("=" * 80)
    ...
    print(f" -> Total Clean Documents: {stats['total_documents']}")
    ...
    print(" -> Steps: Lowercasing, Noise/Punctuation Removal, Stopword Filtering, Lemmatization")
    ...
    # Drop any edge-case documents that became empty after stopword/lemmatization filtering
    ...
    print(f" -> Vocabulary Size (1-gram & 2-grams): {vocab_size} features")
    print(f" -> X_train_tfidf Shape: {X_train_tfidf.shape}")
    print(f" -> X_test_tfidf Shape:  {X_test_tfidf.shape}")

    # Extract top keywords per class using mean TF-IDF
    ...
    print(f"     Accuracy: {best_row['Accuracy']:.4f} | F1-Score: {best_row['F1-Score (Weighted)']:.4f}")
    ...
    print(" To launch the interactive prediction web app, run:")
